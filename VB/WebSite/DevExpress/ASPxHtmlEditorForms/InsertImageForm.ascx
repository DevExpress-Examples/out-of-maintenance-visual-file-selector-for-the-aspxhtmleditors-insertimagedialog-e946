...
{************************************************************************************}
--%>
<%@ Control Language="vb" AutoEventWireup="true" CodeFile="InsertImageForm.ascx.vb"
    Inherits="InsertImageForm" %>
...
<%@ Register Assembly="DevExpress.Web.ASPxHtmlEditor.v9.3, Version=9.3.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="typeRadionButtonListCell">
                                    <table cellpadding="0" cellspacing="0" class="radioButtonTable">
                                        <tr>
                                            <td>
                                                <dxe:ASPxRadioButton ID="rblFromTheWeb" runat="server" GroupName="InsertImageFormGroup"
                                                    Checked="True" TextWrap="False" ClientInstanceName="_dxeRblImageFromTheWeb">
                                                    <ClientSideEvents CheckedChanged="function(s, e) { OnImageFromTypeChanged__InsertImageForm(s); }" />
                                                </dxe:ASPxRadioButton>
                                            </td>
                                            <td>
                                                <dxe:ASPxRadioButton ID="rblFromThisComputer" runat="server" GroupName="InsertImageFormGroup"
                                                    TextWrap="False" ClientInstanceName="_dxeRblImageFromThisComputer">
                                                    <ClientSideEvents CheckedChanged="function(s, e) { OnImageFromTypeChanged__InsertImageForm(s); }" />
                                                </dxe:ASPxRadioButton>
                                            </td>
                                        </tr>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                        <tr>
                                                ...
                                                <dxhe:ASPxHtmlEditorRoundPanel ID="rpInsertImage" runat="server" Width="315px">
                                                    <PanelCollection>
                                                        <dxhe:HtmlEditorRoundPanelContent runat="server">
                                                            <!-- FromTheWeb -->
                                                            <table cellpadding="0" cellspacing="0" id='<% =HtmlEditor.ClientID + "_dxeFromTheWeb" %>'
                                                                class="fromTheWeb">
                                                                <tr>
                                                                    <td>
                                                                        <dxe:ASPxLabel ID="lblImageUrl" runat="server" AssociatedControlID="txbInsertImageUrl">
                                                                        </dxe:ASPxLabel>
                                                                        <div class="captionIndent">
                                                                        </div>
                                                                    ...
                                                                    <ValidationSettings ErrorDisplayMode="Text" ErrorTextPosition="Bottom" SetFocusOnError="True" ValidateOnLeave="False" ValidationGroup="_dxeTbxInsertImageUrlGroup">
                                                                        ...
                                                                        <dxe:ASPxButtonEdit ID="txbInsertImageUrl" ClientInstanceName="_dxeTbxInsertImageUrl"
                                                                            runat="server" Width="274px" AutoCompleteType="Disabled">
                                                                            <ClientSideEvents TextChanged="function(s, e) { aspxInsertImageSrcValueChanged(s.GetText()); }" />
                                                                            <ValidationSettings ErrorDisplayMode="Text" ErrorTextPosition="Bottom" SetFocusOnError="True"
                                                                                ValidateOnLeave="False" ValidationGroup="_dxeTbxInsertImageUrlGroup">
                                                                                <RequiredField IsRequired="True" />
                                                                                <ErrorFrameStyle Font-Size="10px">
                                                                                </ErrorFrameStyle>
                                                                            </ValidationSettings>
                                                                            ...
                                                                            <ClientSideEvents ButtonClick="function(s,e){ ShowFileBrowser();}" />
                                                                        </dxe:ASPxButtonEdit>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                                                            <tr>
                                                                                <td class="imagePreviewCell">
                                                                                    <span id='<% =HtmlEditor.ClientID + "_dxInsertImagePreviewText" %>'>
                                                                                        <% =DevExpress.Web.ASPxHtmlEditor.Localization.ASPxHtmlEditorLocalizer.GetString(DevExpress.Web.ASPxHtmlEditor.Localization.ASPxHtmlEditorStringId.InsertImage_Preview)%></span>
                                                                                    <img id='<% =HtmlEditor.ClientID + "_dxInsertImagePreviewImage"%>' style="display: none;"
                                                                                        width="180" height="100" alt="<% =DevExpress.Web.ASPxHtmlEditor.Localization.ASPxHtmlEditorLocalizer.GetString(DevExpress.Web.ASPxHtmlEditor.Localization.ASPxHtmlEditorStringId.InsertImage_Preview) %>" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                            ...
                                                            <!-- FromThisComputer -->
                                                            <table cellpadding="0" cellspacing="0" id='<% =HtmlEditor.ClientID + "_dxeFromThisComputer" %>'
                                                                style="display: none;">
                                                                <tr>
                                                                    <td>
                                                                      ...
                                                                      This is required to switch the Insert Image dialog to its active state (to remove the Loading Div element).  --%>
                                                                        <dxhe:ASPxHtmlEditorUploadControl ID="uplImage" runat="server" ClientInstanceName="_dxeUplImage"
                                                                            ...
                                                                            <ClientSideEvents FileUploadComplete="function(s, e) { aspxImageUploadComplete(e); }"
                                                                                FilesUploadComplete="function(s, e) { aspxImageUploadComplete(e); }" TextChanged="function(s, e) { aspxImageUploadTextChanged(); }"
                                                                                FileUploadStart="function(s, e) { aspxImageUploadStart(); }" />
                                            ...
                                            <%-- Image Properties --%>
                                            <td id='<% =HtmlEditor.ClientID + "_dxeMoreImagePropertiesRow"%>' class="imagePropertiesCell"
                                                style="display: none">
                            ...
                            <tr>
                                <td class="moreOptionsCell">
                                    <dxe:ASPxCheckBox ID="ckbMoreImageOptions" ClientInstanceName="_dxeCkbMoreImageOptions"
                                        runat="server">
                ...
                <tr>
                    ...
                    <td class="buttonsCell" align="right">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <dxe:ASPxButton ID="btnInsertImage" runat="server" Height="26px" Width="82px" AutoPostBack="false"
                                        ClientInstanceName="_dxeBtnInsertImage" CausesValidation="False">
                                ...
                                <td class="cancelButton">
                                    <dxe:ASPxButton ID="btnInsertImageCancel" runat="server" Height="26px" Width="82px"
